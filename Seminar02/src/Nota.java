public class Nota {
    ...
    public Nota(String _numeDisciplina, int _nota) {
        ...
        if(_nota<1 || _nota>10) {
            throw new IllegalArgumentException("Nota invalida: "+ _nota);
        }
        this.nota=_nota;
    }
    ...
    public String toString() {
        ...
        return String.format("%-18s - %2d",this.numeDisciplina,this.nota);
        //max 18 caractere, liniuta la stanga = aliniere la stanga
        //programare         - 10
